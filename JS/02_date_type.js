...
var year = 2022; // 정수
const PI = 3.14; // 실수
console.log(typeof year, typeof PI); // JS에서는 정수와 실수 구분 없음.
console.log(0.1 + 0.2);
...
// key(속성이름):value(속성값)
var obj = { age: 30, firstName: "seok", lastName: "hwangbo" };
...
console.log("나이합은", user1.age + user2.age);
console.log("키의차이는", user1.height - user2.height);
